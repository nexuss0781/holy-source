...
.method public run()V
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->a:Landroid/content/ComponentName;
    ...
    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->b:Landroid/os/IBinder;
    ...
    invoke-virtual {v1, v3}, Landroid/support/v4/media/MediaBrowserCompat$i$c;->a(Ljava/lang/String;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->b:Landroid/os/IBinder;

    iget-object v5, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->d:Landroid/os/Bundle;

    invoke-direct {v3, v4, v5}, Landroid/support/v4/media/MediaBrowserCompat$l;-><init>(Landroid/os/IBinder;Landroid/os/Bundle;)V

    iput-object v3, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->i:Landroid/support/v4/media/MediaBrowserCompat$l;
    ...
    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->c:Landroid/support/v4/media/MediaBrowserCompat$i$c;
    ...
    iput-object v3, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->j:Landroid/os/Messenger;

    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->c:Landroid/support/v4/media/MediaBrowserCompat$i$c;

    iget-object v1, v1, Landroid/support/v4/media/MediaBrowserCompat$i$c;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v3, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->e:Landroid/support/v4/media/MediaBrowserCompat$a;
    ...
    iput v3, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->g:I
    ...
    iget-object v1, v1, Landroid/support/v4/media/MediaBrowserCompat$i;->i:Landroid/support/v4/media/MediaBrowserCompat$l;

    iget-object v3, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->c:Landroid/support/v4/media/MediaBrowserCompat$i$c;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$i$c;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v3, v3, Landroid/support/v4/media/MediaBrowserCompat$i;->a:Landroid/content/Context;

    iget-object v4, p0, Landroid/support/v4/media/MediaBrowserCompat$i$c$a;->c:Landroid/support/v4/media/MediaBrowserCompat$i$c;

    iget-object v4, v4, Landroid/support/v4/media/MediaBrowserCompat$i$c;->a:Landroid/support/v4/media/MediaBrowserCompat$i;

    iget-object v4, v4, Landroid/support/v4/media/MediaBrowserCompat$i;->j:Landroid/os/Messenger;

    invoke-virtual {v1, v3, v4}, Landroid/support/v4/media/MediaBrowserCompat$l;->b(Landroid/content/Context;Landroid/os/Messenger;)V
    :try_end_0
