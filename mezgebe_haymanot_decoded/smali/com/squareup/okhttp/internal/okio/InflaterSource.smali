...
.method public constructor <init>(Lcom/squareup/okhttp/internal/okio/Source;Ljava/util/zip/Inflater;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/squareup/okhttp/internal/okio/InflaterSource;-><init>(Lcom/squareup/okhttp/internal/okio/BufferedSource;Ljava/util/zip/Inflater;)V
...
.method private releaseInflatedBytes()V
    ...
    iget v0, p0, Lcom/squareup/okhttp/internal/okio/InflaterSource;->bufferBytesHeldByInflater:I
    ...
    :cond_0
    iget-object v1, p0, Lcom/squareup/okhttp/internal/okio/InflaterSource;->inflater:Ljava/util/zip/Inflater;
...
.method public read(Lcom/squareup/okhttp/internal/okio/OkBuffer;J)J
    ...
    iget-boolean v2, p0, Lcom/squareup/okhttp/internal/okio/InflaterSource;->closed:Z
    ...
    :try_start_0
    invoke-virtual {p1, p3}, Lcom/squareup/okhttp/internal/okio/OkBuffer;->writableSegment(I)Lcom/squareup/okhttp/internal/okio/Segment;

    move-result-object p3

    iget-object v0, p0, Lcom/squareup/okhttp/internal/okio/InflaterSource;->inflater:Ljava/util/zip/Inflater;

    iget-object v1, p3, Lcom/squareup/okhttp/internal/okio/Segment;->data:[B

    iget v2, p3, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I

    iget v3, p3, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I
    ...
    iget p2, p3, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I

    add-int/2addr p2, v0

    iput p2, p3, Lcom/squareup/okhttp/internal/okio/Segment;->limit:I

    iget-wide p2, p1, Lcom/squareup/okhttp/internal/okio/OkBuffer;->size:J

    int-to-long v0, v0

    add-long/2addr p2, v0

    iput-wide p2, p1, Lcom/squareup/okhttp/internal/okio/OkBuffer;->size:J

    return-wide v0

    :cond_1
    iget-object p3, p0, Lcom/squareup/okhttp/internal/okio/InflaterSource;->inflater:Ljava/util/zip/Inflater;
...
.method public refill()Z
    ...
    iget-object v0, v0, Lcom/squareup/okhttp/internal/okio/OkBuffer;->head:Lcom/squareup/okhttp/internal/okio/Segment;
    ...
    iget-object v4, p0, Lcom/squareup/okhttp/internal/okio/InflaterSource;->inflater:Ljava/util/zip/Inflater;
